...
const COOKIE_NAME = 'traitharbor_anon_user_id';
...
describe('anonymous user id', () => {
  ...
  it('creates and persists a user id', () => {
    ...
    expect(window.localStorage.getItem('traitharbor:anon-user-id')).toBe('11111111-1111-1111-1111-111111111111');
  ...
  it('reuses an existing cookie value', () => {
    ...
    expect(window.localStorage.getItem('traitharbor:anon-user-id')).toBe('22222222-2222-2222-2222-222222222222');
  });
});
