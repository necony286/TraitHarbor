...
3. If a paid order exists for the email, we create a hashed token in `report_access_links` with a short TTL (900–3600 seconds).
...
- Signed report URLs are ≤ 300 seconds and minted server-side per request.
