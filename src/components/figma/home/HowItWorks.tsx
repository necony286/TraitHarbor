  ...
  return (
    <section id="how-it-works" className="py-16 lg:py-24">
      <div className="text-center mb-12">
        <h2 className="text-3xl lg:text-4xl font-medium text-foreground mb-4">How it works</h2>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
        {STEPS.map((step, index) => {
          ...
          return (
            ...
            >
              <div className="absolute -top-3 -left-3 flex h-8 w-8 items-center justify-center rounded-full bg-primary text-sm font-medium text-primary-foreground shadow-md">
                {index + 1}
              </div>
