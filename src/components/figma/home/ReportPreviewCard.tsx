...
const TRAITS = [
  { name: 'Openness', score: 72, color: '#2563eb' },
  { name: 'Conscientiousness', score: 85, color: '#2563eb' },
  { name: 'Extraversion', score: 58, color: '#2563eb' },
  { name: 'Agreeableness', score: 68, color: '#2563eb' },
  { name: 'Neuroticism', score: 45, color: '#2563eb' }
];
    ...
    <div className="bg-card border border-border rounded-2xl p-6 lg:p-8 shadow-lg">
      ...
      <div className="pt-4 border-t border-border space-y-3">
        <div className="flex items-start gap-3">
          <TrendingUp className="w-4 h-4 text-[#2563eb] mt-0.5 flex-shrink-0" />
          <p className="text-sm text-muted-foreground">
            High conscientiousness suggests strong organizational skills
          </p>
        </div>
        <div className="flex items-start gap-3">
          <Users className="w-4 h-4 text-[#2563eb] mt-0.5 flex-shrink-0" />
          <p className="text-sm text-muted-foreground">
